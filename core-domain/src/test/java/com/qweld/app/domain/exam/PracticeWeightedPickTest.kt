...
class PracticeWeightedPickTest {
    ...
    fun `practice prefers novel items while ip mock is uniform`() {
        ...
        val statsRepoPractice = FakeUserStatsRepository(
            mapOf(
        ...
        val practiceAssembler = ExamAssembler(
        ...
        repeat(40) { idx ->
            val attempt = practiceAssembler.assemble(
                userId = "user",
        ...
        repeat(40) { idx ->
            val attempt = ipAssembler.assemble(
                userId = "user",
